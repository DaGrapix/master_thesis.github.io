...
<div style="display: flex; justify-content: center; align-items: flex-start; gap: 40px;">
  <div style="flex: 1; text-align: center;">
    <img src="assets/models/transformer.svg" alt="Transformer Architecture" style="height:60%; width:auto; display:inline-block;">
  </div>
  <div style="flex: 1; text-align: center;">
    <img src="assets/transformer_image.png" alt="Transformer Illustration" style="height:30%; width:auto; display:inline-block;">
